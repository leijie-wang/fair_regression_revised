...
class Moment:
    ...
    def load_data(self, X, y, **kwargs):
        ...
        self.X = X
        self.tags = pd.DataFrame({_LABEL: y})#type: DataFrame; value similar to a column vector of dimension n.
        if _KW_SENSITIVE_FEATURES in kwargs: #the value is "sensitive_features"
